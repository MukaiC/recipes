    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directions', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to='recipes.method')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='method',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='methods', to='recipes.recipe'),
        ),
    ]
